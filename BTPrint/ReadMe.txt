================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : BTPrint Project Overview
===============================================================================

The application wizard has created this BTPrint application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your BTPrint application.
...
BTPrint.h
    ...
    project specific headers and declares the CBTPrintApp application class.
...
BTPrintDlg.h, BTPrintDlg.cpp - the dialog
    These files contain your CBTPrintDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named BTPrint.pch and a precompiled types file named StdAfx.obj.
